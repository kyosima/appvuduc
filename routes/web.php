...
Route::prefix('admin')->group(function(){
    Route::middleware(['auth'])->group(function () {
        ...
        Route::get('/don-hang-dai-ly', function () {
        ...
        Route::get('/nganh-nhom-hang', function () {
...
Route::get('/dangky', 'App\Http\Controllers\User\RegisterController@index')->name('dangky');
Route::post('/dangky', 'App\Http\Controllers\User\RegisterController@create');

Route::get('/dangnhap', 'App\Http\Controllers\User\LoginController@index')->name('dangnhap');
Route::post('/dangnhap', 'App\Http\Controllers\User\LoginController@store');

Route::get('/dangxuat', 'App\Http\Controllers\User\LoginController@destroy')->name('dangxuat');

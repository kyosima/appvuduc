...
class CartController extends Controller
{
    ...
    public function index(){
        ...
        return view('public.cart_checkout.cart', ['carts' => $carts, 'cart_subtotal' => $cart_subtotal, 'cart_total'=>$cart_total]);
    }
    ...
    public function addCart(Request $request){
        ...
        Cart::instance('shopping')->add(['id'=> $product->id,'name'=> $product->name, 'price'=> $product->productPrice()->value('regular_price'), 'qty'=>$qty])->associate('App\Models\Product');

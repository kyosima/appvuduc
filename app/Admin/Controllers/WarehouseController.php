...
class WarehouseController extends Controller
{
    public function index()
    {
        ...
        return view('admin.warehouse.ton-kho-dai-ly', compact('warehouses', 'index', 'products', 'cities'));
    }
    ...
    public function modalEdit(Request $request)
    {
        ...
        $returnHTML = view('admin.warehouse.formUpdate', compact('unit', 'productEdit', 'cities', 'products', 'districts', 'wards'))->render();
